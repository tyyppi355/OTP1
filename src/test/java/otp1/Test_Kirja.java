...
public class Test_Kirja {
	...
	void test_kirja_Kirja_id() {
		...
		assertEquals(12323, kirja.getKirja_id(), "Tiedot eivät oikein");
	}

	@Test
	void test_kirja_Kirja_ISBN() {
		kirja.setKirja_ISBN(834758347);
		assertEquals(834758347, kirja.getKirja_ISBN(), "Tiedot eivät oikein");
	}

	@Test
	void test_kirja_Luokka() {
		kirja.setLuokka("1.12");
		assertEquals("1.12", kirja.getLuokka(), "Tiedot eivät oikein");
	}

	@Test
	void test_kirja_Tila() {
		kirja.setTila("hyllyssä");
		assertEquals("hyllyssä", kirja.getTila(), "Tiedot eivät oikein");
	}
	...
	void test_kirja_Lainaaja() {
		...
		assertEquals(Asiakas, kirja.getLainaaja(), "Tiedot eivät oikein");
	}
	...
	void test_kirja_kirjasto() {
		...
		assertEquals(kirjasto, kirja.getKirjasto(), "Tiedot eivät oikein");
	}
	...
	void test_kirja_kirjatiedot() {
		...
		assertEquals(kirjatiedot, kirja.getkTiedot(), "Tiedot eivät oikein");
	}

	@Test
	void test_kirja_Kirjasto_id() {
		kirja.setKirjasto_id(1290);
		assertEquals(1290, kirja.getKirjasto_id(), "Tiedot eivät oikein");
	}
